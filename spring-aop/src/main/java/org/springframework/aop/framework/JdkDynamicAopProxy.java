...
/**
 * JdkDynamicAopProxy：基于JDK动态代理的AOP代理实现
 *
 * @author Rod Johnson
...
final class JdkDynamicAopProxy implements AopProxy, InvocationHandler, Serializable {
	...
	/** 代理配置：Config used to configure this proxy. */
	...
	/**
	 * equals方法是否定义：Is the {@link #equals} method defined on the proxied interfaces?
	 */
	private boolean equalsDefined;

	/**
	 * hashCode方法是否定义：Is the {@link #hashCode} method defined on the proxied interfaces?
	 */
	...
	public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
		...
		try {
			...
			// 获取已定义好的拦截器链：Get the interception chain for this method.

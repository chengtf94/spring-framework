...
/**
 * AbstractAutowireCapableBeanFactory：可自动的BeanFactory抽象基类
 *
 * @author Rod Johnson
...
public abstract class AbstractAutowireCapableBeanFactory
	...
	/** Bean实例化策略：默认为CglibSubclassingInstantiationStrategy */
	...
	protected Object doCreateBean(String beanName, RootBeanDefinition mbd, @Nullable Object[] args)
		...
		// #2 执行合并Bean定义后置处理：Allow post-processors to modify the merged bean definition.
		...
		// #3 提前暴漏的单例Bean：用于解决缓存依赖问题：Eagerly cache singletons to be able to resolve circular references even when triggered by lifecycle interfaces like BeanFactoryAware.
	...
	/**
	 * 实例化Bean：Instantiate the given bean using its default constructor.
	 * @param beanName the name of the bean
	 * @param mbd the bean definition for the bean
	 * @return a BeanWrapper for the new instance
	 */
	...
	protected Object initializeBean(String beanName, Object bean, @Nullable RootBeanDefinition mbd) {
		...
		// #2 在Bean初始化之前，执行postProcessBeforeInitialization方法
		Object wrappedBean = bean;
		if (mbd == null || !mbd.isSynthetic()) {
			wrappedBean = applyBeanPostProcessorsBeforeInitialization(wrappedBean, beanName);
		}

		// #3 调用初始化方法，包括afterPropertiesSet方法、自定义初始化方法
		try {
		...
		// #4 在Bean初始化之后，执行postProcessAfterInitialization方法
		if (mbd == null || !mbd.isSynthetic()) {
	...
	protected void invokeInitMethods(String beanName, Object bean, @Nullable RootBeanDefinition mbd)
		...
		// #1 若当前Bean实现了InitializingBean接口，则回调afterPropertiesSet方法
		...
		// #2 执行自定义初始化方法，通常是通过xml文件配置的init-method方法

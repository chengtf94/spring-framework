...
/**
 * RootBeanDefinition：根节点Bean定义，不需要合并、不存在parent；大多数Bean都是这种，除非当前Bean有继承，则会被注册为GenericBeanDefinition
 *
 * @author Rod Johnson
...
public class RootBeanDefinition extends AbstractBeanDefinition {
	...
	/** 已经解析过的构造器方法或工厂方法：属于缓存机制，不用重复解析 Package-visible field for caching the resolved constructor or factory method. */
	@Nullable
